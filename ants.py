...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if type(insect) == QueenAnt and not insect.duplicate:
                return
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        if self.place.ant is not None:
            return self.place.ant.blocks_path is not False
        else:
            return False
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        current_distance = 0
        while location != hive:
            if self.min_range <= current_distance <= self.max_range and len(location.bees) != 0:
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        if insect.watersafe is not True:
...
# END Problem 13
    ...
    def __init__(self):
        ...
        if QueenAnt.duplicate_count == 1:
            self.duplicate = True
        QueenAnt.duplicate_count = 1
        # END Problem 13
        ...
        if self.duplicate == False:
            ...
            while previous_place != None:
                if previous_place.ant != None:
                    if previous_place.ant not in self.already_doubled:
                        previous_place.ant.damage = previous_place.ant.damage * 2
                        self.already_doubled.append(previous_place.ant)
                    if previous_place.ant.container and previous_place.ant.ant and previous_place.ant.ant not in self.already_doubled:
                        previous_place.ant.ant.damage = previous_place.ant.ant.damage * 2
                        self.already_doubled.append(previous_place.ant.ant)
                previous_place = previous_place.exit
            ThrowerAnt.action(self, colony)
        elif self.duplicate == True:
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    turn_number = 0
    real_action = bee.action
    def effect_action(colony):
        nonlocal turn_number, duration
        if turn_number < duration:
            turn_number += 1
            effect(real_action)(colony)
        else:
            real_action(colony)
